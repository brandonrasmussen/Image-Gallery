Image Gallery for The Web Developer Bootcamp by Colt Steele on Udemy

Description:
Project to practice using Bootstrap and it's components to make a responsive image website. 
